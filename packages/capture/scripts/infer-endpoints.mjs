...
// `normalizePath` lives in shared since 0041 §3.1: infer binds URLs out of
// control attributes and must normalise them with the same grammar capture
// uses for observed ones, or 0015 §2's shape match compares two languages.
import {
  classifyStringField,
  dedupeByIdentity,
  IDENTITY_KEYS,
